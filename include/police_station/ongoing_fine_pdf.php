...
class MYPDF extends TCPDF
{
    ...
    public function ColoredTable($header, $data)
    {
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($w[5], 6, $row['remaining_days'] . " Days Remaining", 'LR', 0, 'L', $fill);
            $this->Ln();
            $fill = !$fill;
        }
...
// column titles
$header = array('FINE ID', 'VIOLATION', 'PAYMENT STATUS', 'POINTS', 'AMOUNT(RS)', 'OVERDUE DATE');
