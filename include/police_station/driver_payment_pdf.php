...
class MYPDF extends TCPDF
{
    ...
    public function ColoredTable($header, $data)
    {
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($w[2], 6, $row['Nic_No'], 'LR', 0, 'L', $fill);
            ...
            $this->Cell($w[6], 6, $row['created_at'], 'LR', 0, 'L', $fill);
            $this->Ln();
            $fill = !$fill;
        }
...
$pdf->SetTitle('Driver Payment Details');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Driver Payment details', PDF_HEADER_STRING);
...
// column titles
$header = array('PAYMENT ID', 'DRIVER NAME', 'DRIVER NIC', 'VIOLATION', 'REDUCE POINTS', 'AMOUNT(RS)', 'PAYMENT DATE');
...
$pdf->Output('driver_payment.pdf', 'I');
